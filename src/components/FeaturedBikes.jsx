...
import { FEATURED_BIKES } from "../constants/data.js";
import { FaArrowRightLong } from "react-icons/fa6";

const FeaturedBikes = () => {
  return (
    <div className="mt-10 px-5 w-full text-text-primary">
      <div className="relative">
        <h1 className="font-primary relative z-50 text-xl">Featured Bikes</h1>
        <img
